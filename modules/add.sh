...
env_stage "Installing Environment Modules in environment: ${name}"

mkdir -p ${flight_ENV_ROOT}/${name}/modules/modulefiles
cp ${flight_ENV_ROOT}/share/modules/${v}/modulefiles/null ${flight_ENV_ROOT}/${name}/modules/modulefiles
cat <<EOF > ${flight_ENV_ROOT}/${name}/modules/modules.bash.rc
module use ${flight_ENV_ROOT}/${name}/modules/modulefiles
EOF
cat <<EOF > ${flight_ENV_ROOT}/${name}/modules/modules.tcsh.rc
module use ${flight_ENV_ROOT}/${name}/modules/modulefiles
EOF
