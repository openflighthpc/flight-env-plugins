# Contributing to Flight Environment Plugins

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to Flight Environment Plugins? Welcome! Please read this
...
You can help Flight Environment Plugins by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/openflighthpc/flight-env-plugins/issues?state=open)
...
If you find a bug - behaviour of Flight Environment Plugins code or documentation
...
[GitHub issue tracker for Flight Environment Plugins](https://github.com/openflighthpc/flight-env-plugins/issues/new)
to report the issue.
...
We want to improve the quality of Flight Environment Plugins and good bug reports are
...
Flight Environment Plugins is Open Source and comes without warranty.
...
Flight Environment Plugins in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of Flight Environment Plugins and really improve it. The more
...
applied to Flight Environment Plugins itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/openflighthpc/flight-env-plugins). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the Flight Environment Plugins developers also have their regular
